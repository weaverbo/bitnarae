...
export default function ProgramSection() {
  ...
  // const [onInViewRef1, inView1] = useInView({
  //   triggerOnce: true,
  //   threshold: 1,
  // });
    ...
    <>
      <div className="container mt-[160px] mb-[320px]">
        ...
        <div className="flex gap-[32px] mt-[80px]">
          <div className="program-container" ref={onInViewRef}>
            <motion.div initial={{ scale: 0.2, opacity: 0 }} animate={inView ? { scale: 1, opacity: 1 } : {}} transition={{ duration: 0.8, ease: "easeOut", delay: 0 }} className="w-full h-full">
          ...
          <div className="program-container" ref={onInViewRef}>
            <motion.div initial={{ scale: 0.2, opacity: 0 }} animate={inView ? { scale: 1, opacity: 1 } : {}} transition={{ duration: 0.8, ease: "easeOut", delay: 0.8 }} className="w-full h-full">
        ...
        <div className="flex gap-[32px] mt-[32px]">
          <div className="program-container" ref={onInViewRef}>
            <motion.div initial={{ scale: 0.2, opacity: 0 }} animate={inView ? { scale: 1, opacity: 1 } : {}} transition={{ duration: 0.8, ease: "easeOut", delay: 1.5 }} className="w-full h-full">
